...
disp(['Total energy consumed: ' num2str(energy) ' Joules']);
...
sim_torque_highway = simout_highway.torque_highway.Data; %units: Nm
sim_angularvelocity_highway = simout_highway.angularvelocity_highway.Data; %units: rpm
