...
prev_section = 6;
loops = 0;
tloops = zeros(1, 1000); % ADDED IN: define tloops assuming the max laps is 1000
j = 0;
k = 0;
Xerr = [];
Yerr = [];
...
tloops = tloops(tloops ~= 0); % remove instantiated tloop values that were instantiated but not used
